...
public class Task18Test {
    ...
    void test_get_more_heaviest_fish_among_some_zoos() {
        ...
        List<List<Animal>> chainZoo = new ArrayList<>(List.of(
            new ArrayList<>(List.of(dog, cat, parrot)),
            new ArrayList<>(List.of(shark1,shark2,shark3,shark4,shark5)),
            new ArrayList<>(List.of(shark6, shark7, shark8, shark9)),
            new ArrayList<>(List.of(whole1, whole2, whole3, whole4, digger)),
            new ArrayList<>(List.of(whole5, whole6, whole7, whole8, whole9))
        )
        );
