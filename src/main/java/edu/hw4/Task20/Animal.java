...
public record Animal(
    ...
    private final static Map<String, String> GET_ALL_ERRORS = new HashMap<>();

    public static Map<String, Set<ConstraintViolation<Animal>>> getErrorsCreate() {
        return ERRORS_CREATE;
    }

    public static Map<String, String> getGetAllErrors() {
    ...
    private void checkAnimalThroughAnimalValidator() {
        var validations = AnimalValidator.validateAnimal(this);
        ERRORS_CREATE.put(this.name, validations);

        StringBuilder errors = new StringBuilder();

        for (var validation : validations) {
            errors.append(validation.getMessageTemplate()).append("; ");
        }

        GET_ALL_ERRORS.put(this.name, errors.toString());
    }
